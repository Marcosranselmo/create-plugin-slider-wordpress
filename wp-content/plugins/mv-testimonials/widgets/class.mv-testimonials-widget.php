    ...
    public function form( $instance ){
        ...
        ?>
            ...
            <p>
                ...
                <input type="number" class="tiny-test" id="<?php echo $this->get_field_id( 'number' ); ?>" name="<?php echo 
            ...
            <p>
                ...
                <label for="<?php echo $this->get_field_id( 'image' ); ?>"><?php esc_html_e( 'display user iamge?', 'mv-testimonials' ); ?></label>
            </p>
